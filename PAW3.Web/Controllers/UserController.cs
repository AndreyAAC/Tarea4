...
public class UserController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        try
        {
            ...
            var summaries = users.Select(u => new SummaryViewModel
            {
                Id = u.UserId,
        ...
        catch (Exception ex)
        {
            ...
            return View(new UserPageViewModel { Users = [], Summaries = [] });
        }
    }
