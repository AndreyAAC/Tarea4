...
public class UserActionController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        try
        {
            ...
            var summaries = userActions.Select(a => new SummaryViewModel
            {
                Id = a.Id,
                Name = a.Name ?? "(no name)",
                Value = a.Description ?? "",
            ...
            var vm = new UserActionPageViewModel
            {
        ...
        catch (Exception ex)
        {
            ...
            return View(new UserActionPageViewModel { UserActions = [], Summaries = [] });
        }
    }
    ...
    public async Task<IActionResult> Details(int id)
    {
        try
        {
            ...
            if (userAction == null) return NotFound();
    ...
    public async Task<IActionResult> Edit(int id, UserActionViewModel userAction)
    {
        try
        {
            if (id != (int?)userAction.Id) return NotFound();
