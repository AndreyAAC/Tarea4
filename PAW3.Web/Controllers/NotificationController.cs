...
public class NotificationController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        try
        {
            ...
            var summaries = notifications.Select(n => new SummaryViewModel
            {
                Id = n.Id,
                Name = $"User {n.UserId}",
                Value = n.IsRead == true ? "Read" : "Unread",
                Count = 1
            }).ToList();
        ...
        catch (Exception ex)
        {
            ...
            return View(new NotificationPageViewModel { Notifications = [], Summaries = [] });
        }
    }
